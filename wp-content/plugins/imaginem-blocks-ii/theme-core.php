...
class Theme_Core {
    ...
    public function mtheme_load_admin_styles() {
		...
		wp_register_style('themecore-admin-styles', plugin_dir_url( __FILE__ ) .'admin/css/style.css',false, '1.2', 'screen' );
    ...
    public function mtheme_load_front_end_scripts_styles() {
		...
		wp_register_script( 'inview', plugin_dir_url( __FILE__ ) .'assets/js/jquery.inview.min.js', array( 'jquery' ),null, true );
		...
		// Kenburns
		wp_register_script( 'slideshowify', plugin_dir_url( __FILE__ ) .'assets/js/kenburns/jquery.slideshowify.js', array( 'jquery' ), '1.3',true );
		wp_register_script( 'blacksilver-kenburns-init', plugin_dir_url( __FILE__ ) .'assets/js/kenburns/kenburns.init.js', array( 'jquery' ), '1.4',true );
		wp_register_script( 'transit', plugin_dir_url( __FILE__ ) .'assets/js/kenburns/jquery.transit.min.js', array( 'jquery' ), null,true );

		// Supersized
		wp_register_script( 'supersized', plugin_dir_url( __FILE__ ) .'assets/js/supersized/supersized.3.2.7.min.js', array( 'jquery' ), '1.3',true );
		wp_register_script( 'supersized-shutter', plugin_dir_url( __FILE__ ) .'assets/js/supersized/supersized.shutter.js', array( 'jquery' ), '1.3',true );
		...
		wp_register_script( 'blacksilver-carousel', plugin_dir_url( __FILE__ ) .'assets/js/hcarousel.js', array( 'jquery' ), '1.3',true );

		wp_register_script( 'tilt', plugin_dir_url( __FILE__ ) .'assets/js/tilt.jquery.js', array( 'jquery' ), null,true );

        wp_register_script( 'swiper', plugin_dir_url( __FILE__ ) .'assets/js/swiper/swiper.min.js', array( 'jquery' ), null,true );

		// Grid Rotator
		wp_register_script( 'gridrotator', plugin_dir_url( __FILE__ ) .'assets/js/jquery.gridrotator.js', array( 'modernizr' ), '1.2',true );
		...
		wp_register_script( 'jarallax', plugin_dir_url( __FILE__ ) .'assets/js/jarallax/jarallax.js', array( 'jquery' ), '1.3',true );
		...
		wp_register_script( 'lightgallery', plugin_dir_url( __FILE__ ) .'assets/js/lightbox/js/lightgallery-all.js', array( 'jquery' ),'1.4', true );
		...
		public function themecore_add_page_box() {
			add_meta_box('common-pagemeta-box', esc_html__('General Page Metabox','imaginem-blocks-ii'), 'themecore_common_show_pagebox', 'page', 'normal', 'core');
		}
		// Client Metabox
		public function themecore_clientitemmetabox_init(){
			add_meta_box('mtheme_clientInfo-meta', esc_html__('Client Options','imaginem-blocks-ii'), 'themecore_clientitem_metaoptions', 'clients', 'normal', 'low');
		}
		// Events Metabox
		public function themecore_eventsitemmetabox_init(){
			add_meta_box('eventsInfo-meta', esc_html__('Events Options','imaginem-blocks-ii'), 'themecore_eventsitem_metaoptions', 'events', 'normal', 'low');
		}
		// Fullscreen Metabox
		public function themecore_fullscreenitemmetabox_init(){
			add_meta_box('fullscreen-meta', esc_html__('Featured Options','imaginem-blocks-ii'), 'themecore_featured_options', 'fullscreen', 'normal', 'low');
		}
		// Portfolio Metabox
        ...
        public function themecore_woocommerceitemmetabox_init(){
            add_meta_box('mtheme_woocommerceInfo-meta', esc_html__('WooCommerce Options','imaginem-blocks-ii'), 'themecore_woocommerceitem_metaoptions', 'product', 'normal', 'low');
        }
