...
class Share_Page extends Widget_Base {
	...
	public function get_title() {
		return __( 'Share Page', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Share Page', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
			...
			[
			    'std' => 'Share',
			    'type' => 'text',
			    'label' => __('Share text', 'imaginem-blocks-ii'),
				'desc' => __('Share text displayed on hover', 'imaginem-blocks-ii'),
			]
		);
		...
		[
			...
			'label' => __('Facebook', 'imaginem-blocks-ii'),
		...
		[
			'type' => \Elementor\Controls_Manager::SWITCHER,
			'label' => __('Twitter', 'imaginem-blocks-ii'),
			'label_on' => __( 'Show', 'your-plugin' ),
			'label_off' => __( 'Hide', 'your-plugin' ),
			'return_value' => 'yes',
			'default' => 'yes',
		...
		[
			'type' => \Elementor\Controls_Manager::SWITCHER,
			'label' => __('Linkedin', 'imaginem-blocks-ii'),
			'label_on' => __( 'Show', 'your-plugin' ),
			'label_off' => __( 'Hide', 'your-plugin' ),
			'return_value' => 'yes',
			'default' => 'yes',
		...
		[
			'type' => \Elementor\Controls_Manager::SWITCHER,
			'label' => __('Googleplus', 'imaginem-blocks-ii'),
			'label_on' => __( 'Show', 'your-plugin' ),
			'label_off' => __( 'Hide', 'your-plugin' ),
			'return_value' => 'yes',
			'default' => 'yes',
		...
		[
			'type' => \Elementor\Controls_Manager::SWITCHER,
			'label' => __('Reddit', 'imaginem-blocks-ii'),
			'label_on' => __( 'Show', 'your-plugin' ),
			'label_off' => __( 'Hide', 'your-plugin' ),
			'return_value' => 'yes',
			'default' => 'yes',
		...
		[
			'type' => \Elementor\Controls_Manager::SWITCHER,
			'label' => __('Tumblr', 'imaginem-blocks-ii'),
			'label_on' => __( 'Show', 'your-plugin' ),
			'label_off' => __( 'Hide', 'your-plugin' ),
			'return_value' => 'yes',
			'default' => 'yes',
		...
		[
			'type' => \Elementor\Controls_Manager::SWITCHER,
			'label' => __('Pinterest', 'imaginem-blocks-ii'),
			'label_on' => __( 'Show', 'your-plugin' ),
			'label_off' => __( 'Hide', 'your-plugin' ),
			'return_value' => 'yes',
			'default' => 'yes',
		...
		[
			'type' => \Elementor\Controls_Manager::SWITCHER,
			'label' => __('Email', 'imaginem-blocks-ii'),
			'label_on' => __( 'Show', 'your-plugin' ),
			'label_off' => __( 'Hide', 'your-plugin' ),
			'return_value' => 'yes',
			'default' => 'yes',
		...
		$this->add_control(
			'text_hover_color',
			[
				'label' => __( 'Hover icon color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					// Stronger selector to avoid section style from overwriting
		...
		$this->add_control(
			...
			[
				'label' => __( 'Hover icon background colors', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					// Stronger selector to avoid section style from overwriting
	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
		$widgets[ $this->get_name() ] = [
			...
			'fields'     => [
				[
					'field'       => 'share',
					'type'        => __( 'Share', 'imaginem-blocks-ii' ),
					'editor_type' => 'LINE'
				],
			],
		];
