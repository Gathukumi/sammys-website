...
class Google_Map extends Widget_Base {
	...
	public function get_title() {
		return __( 'Google Map', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Google Map', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
		    'map_notice',
		    [
			    'label' => __( 'Find Latitude & Longitude', 'imaginem-blocks-ii' ),
			    'type'  => Controls_Manager::RAW_HTML,
		...
		$this->add_control(
			'map_lat',
			[
				'label' => __( 'Latitude', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'map_lng',
			[
				'label' => __( 'Longitude', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'zoom',
			[
				'label' => __( 'Zoom Level', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'map_type',
			[
				'label' => __( 'Map Type', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'roadmap' => __( 'Road Map', 'imaginem-blocks-ii' ),
					'satellite' => __( 'Satellite', 'imaginem-blocks-ii' ),
					'hybrid' => __( 'Hybrid', 'imaginem-blocks-ii' ),
					'terrain' => __( 'Terrain', 'imaginem-blocks-ii' ),
				],
				'default' => 'roadmap',
			]
		);
		...
		$this->add_control(
			'zoom_control',
			[
				'label' => __( 'Show Zoom Control', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Control Position', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'RIGHT_BOTTOM' => __( 'Bottom Right (Default)', 'imaginem-blocks-ii' ),
					'TOP_LEFT' => __( 'Top Left', 'imaginem-blocks-ii' ),
					'TOP_CENTER' => __( 'Top Center', 'imaginem-blocks-ii' ),
					'TOP_RIGHT' => __( 'Top Right', 'imaginem-blocks-ii' ),
					'LEFT_CENTER' => __( 'Left Center', 'imaginem-blocks-ii' ),
					'RIGHT_CENTER' => __( 'Right Center', 'imaginem-blocks-ii' ),
					'BOTTOM_LEFT' => __( 'Bottom Left', 'imaginem-blocks-ii' ),
					'BOTTOM_CENTER' => __( 'Bottom Center', 'imaginem-blocks-ii' ),
					'BOTTOM_RIGHT' => __( 'Bottom Right', 'imaginem-blocks-ii' ),
				],
		...
		$this->add_control(
			'default_ui',
			[
				'label' => __( 'Show Default UI', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			'map_type_control',
			[
				'label' => __( 'Map Type Control', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Control Styles', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'DEFAULT' => __( 'Default', 'imaginem-blocks-ii' ),
					'HORIZONTAL_BAR' => __( 'Horizontal Bar', 'imaginem-blocks-ii' ),
					'DROPDOWN_MENU' => __( 'Dropdown Menu', 'imaginem-blocks-ii' ),
				],
				'default' => 'DEFAULT',
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'TOP_LEFT' => __( 'Top Left (Default)', 'imaginem-blocks-ii' ),
					'TOP_CENTER' => __( 'Top Center', 'imaginem-blocks-ii' ),
					'TOP_RIGHT' => __( 'Top Right', 'imaginem-blocks-ii' ),
					'LEFT_CENTER' => __( 'Left Center', 'imaginem-blocks-ii' ),
					'RIGHT_CENTER' => __( 'Right Center', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'streetview_control',
			[
				'label' => __( 'Show Streetview Control', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Streetview Position', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'RIGHT_BOTTOM' => __( 'Bottom Right (Default)', 'imaginem-blocks-ii' ),
					'TOP_LEFT' => __( 'Top Left', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'custom_map_style',
			[
				'label' => __( 'Custom Map Style', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'marker',
			[
				'label' => __( 'Marker Color', 'imaginem-blocks-ii' ),
