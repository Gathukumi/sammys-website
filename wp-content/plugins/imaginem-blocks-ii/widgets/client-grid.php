 ...
 * @since 1.0.0
 */
class Em_Clients_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Client Grid', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Client Grid', 'imaginem-blocks-ii' ),
			]
		);
	...
	protected function render() {
		...
		$shortcode = '[gridcreate imagesize="'.$settings['imagesize'].'" grid_post_type="clients" showcomments="false" showdate="false" displayreadmore="false" category_display="false" effect="'.$settings['effect'].'" style="'.$settings['style'].'" columns="'.$settings['columns'].'" format="'.$settings['format'].'" title="'.$settings['title'].'" desc="'.$settings['desc'].'" pagination="'.$settings['pagination'].'" limit="'.$settings['limit'].'"]';
