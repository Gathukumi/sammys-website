...
class Proofing_Archive extends Widget_Base {
	...
	public function get_title() {
		return __( 'Proofing Archive', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Proofing Archive', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'label' => __('Choose Proofing category to list', 'imaginem-blocks-ii'),
		...
		$this->add_control(
		    'worktypecolor',
			[
				'label' => __('Proofing Category Color', 'imaginem-blocks-ii'),
		        'std' => '',
		        'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'label' => __( 'Proofing Category Typography', 'imaginem-blocks-ii' ),
				'name' => 'worktypetype',
