...
class Em_Multi_Slider extends Widget_Base {
	...
	public function get_title() {
		return __( 'Multi Slider', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Multi Slider', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
			'slideshowimage_mode',
			[
				'label' => __( 'Slideshow Image', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'cover' => __( 'Cover', 'imaginem-blocks-ii' ),
					'fit'   => __( 'Fit', 'imaginem-blocks-ii' ),
				],
				'default'      => 'cover',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Overlay Opacity', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Overlay Hover Opacity', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => .25,
				],
		...
		$this->add_control(
			...
			[
				'type' => 'select',
				'label' => __('Slide style', 'imaginem-blocks-ii'),
				'desc' => __('Slide style', 'imaginem-blocks-ii'),
				'options' => [
					'slide' => __('Slide','imaginem-blocks-ii'),
					'fade' => __('Fade','imaginem-blocks-ii')
				],
				'condition' => [
					'columns' => '1',
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'fraction' => __( 'Fraction', 'imaginem-blocks-ii' ),
					'no' => __( 'No', 'imaginem-blocks-ii' ),
				],
				'default' => 'yes',
				'separator' => 'before',
		...
		$this->add_control(
			'lightbox',
			[
				'label' => __( 'Lightbox', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'no' => __( 'No', 'imaginem-blocks-ii' ),
					'yes' => __( 'Yes', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			...
			[
				'type' => \Elementor\Controls_Manager::SELECT,
				'label' => __('Scroll Indicator', 'imaginem-blocks-ii'),
				'desc' => __('Style of Thumbnails', 'imaginem-blocks-ii'),
				'options' => [
					'disable' => __('Disable', 'imaginem-blocks-ii'),
					'enable' => __('Enable', 'imaginem-blocks-ii'),
				],
				'default' => 'disable',
				'separator' => 'before',
			]
		...
		$this->add_control(
			'scroll_align',
			[
				'label' => __( 'Scroll indicator align', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'left'   => __( 'Left', 'imaginem-blocks-ii' ),
					'center' => __( 'Center', 'imaginem-blocks-ii' ),
					'right'  => __( 'Right', 'imaginem-blocks-ii' ),
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
		        ...
		        'label' => __('Link to', 'imaginem-blocks-ii'),
		...
		$this->start_controls_section(
			'section_contenttext',
			[
				'label' => __( 'Slideshow Content', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
			'slideshowtext_align',
			[
				'label' => __( 'Slideshow Text Align', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'left'   => __( 'Left', 'imaginem-blocks-ii' ),
					'center' => __( 'Center', 'imaginem-blocks-ii' ),
		...
		$this->add_responsive_control(
			'left_alignment',
			[
				'label' => __( 'Content Left Alignment', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 10,
				],
		...
		$this->add_responsive_control(
			'bottom_alignment',
			[
				'label' => __( 'Content Bottom Alignment', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 20,
				],
		...
		$this->add_responsive_control(
			'content_space',
			[
				'label' => __( 'Content Padding', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'display_title',
			[
				'label' => __( 'Display Title', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'yes' => __( 'Yes', 'imaginem-blocks-ii' ),
					'no' => __( 'No', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'display_desc',
			[
				'label' => __( 'Display Description', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'yes' => __( 'Yes', 'imaginem-blocks-ii' ),
					'no' => __( 'No', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'display_button',
			[
				'label' => __( 'Display Button', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'yes' => __( 'Yes', 'imaginem-blocks-ii' ),
					'no' => __( 'No', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'indicator_color',
			[
				'label' => __( 'Indicator Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					// Stronger selector to avoid section style from overwriting
