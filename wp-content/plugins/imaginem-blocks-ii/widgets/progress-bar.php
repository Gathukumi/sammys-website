...
class Progress_Bar extends Widget_Base {
	...
	public function get_title() {
		return __( 'Progress Bar', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_progress',
			[
				'label' => __( 'Progress Bar', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'My Skill', 'imaginem-blocks-ii' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'percent',
			[
				'label' => __( 'Percentage', 'imaginem-blocks-ii' ),
		...
		$this->add_control( 'display_percentage', [
			'label' => __( 'Display Percentage', 'imaginem-blocks-ii' ),
			'type' => Controls_Manager::SELECT,
			'default' => 'show',
			'options' => [
				'show' => __( 'Show', 'imaginem-blocks-ii' ),
				'hide' => __( 'Hide', 'imaginem-blocks-ii' ),
			],
		] );
		...
		$this->add_control(
			'bar_color',
			[
				'label' => __( 'Progress Color', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'bar_bg_color',
			[
				'label' => __( 'Progress Bar Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Title Style', 'imaginem-blocks-ii' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'title_color',
			[
				'label' => __( 'Text Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'skill_color',
			[
				'label' => __( 'Skill Percent Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
