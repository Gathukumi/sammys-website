...
class Em_Like_Status extends Widget_Base {
	...
	public function get_title() {
		return __( 'Like Status', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Like Status Page', 'imaginem-blocks-ii' ),
			]
		);
		...
		[
			...
			'label' => __('Display Large', 'imaginem-blocks-ii'),
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => __( 'Icon Size', 'imaginem-blocks-ii' ),
		...
		$this->add_responsive_control(
			'count_top',
			[
				'label' => __( 'Count Top', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -100,
		...
		$this->add_responsive_control(
			'count_right',
			[
				'label' => __( 'Count Right', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
