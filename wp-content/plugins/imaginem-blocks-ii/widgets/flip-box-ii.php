 ...
 * @since 1.0.0
 */
class Em_FlipBox extends Widget_Base {
	...
	public function get_title() {
		return __( 'Flip Box II', 'elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
		        ...
		        'label' => __('Flip Box Title', 'imaginem-blocks-ii'),
		...
		$this->add_control(
			...
			[
		        ...
		        'label' => __('Flip Box Content', 'imaginem-blocks-ii'),
	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
		$widgets[ $this->get_name() ] = [
			...
			'fields'     => [
				[
					'field'       => 'title',
					'type'        => __( 'Flip Box Title', 'imaginem-blocks-ii' ),
					'editor_type' => 'LINE'
				],
				[
					'field'       => 'content',
					'type'        => __( 'Flip Box Content', 'imaginem-blocks-ii' ),
					'editor_type' => 'AREA'
				],
				[
					'field'       => 'button_text',
