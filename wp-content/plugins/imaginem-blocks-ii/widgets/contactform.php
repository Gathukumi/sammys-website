...
class ContactForm extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact 7 Form', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'ContactForm', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
			'input_color',
			[
				'label' => __( 'Input Fields', 'imaginem-blocks-ii' ),
		...
		$this->add_group_control(
			...
			[
				'label' => __( 'Input Type', 'imaginem-blocks-ii' ),
				'name' => 'input_type',
		...
		$this->add_control(
			'label_color',
			[
				'label' => __( 'Label Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'label' => __( 'Label Type', 'imaginem-blocks-ii' ),
				'name' => 'form_label',
		...
		$this->add_control(
			'inputborder',
			[
				'label' => __( 'Input Border Style', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => __( 'Default', 'imaginem-blocks-ii' ),
					'curved' => __( 'Curved', 'imaginem-blocks-ii' ),
					'bottom' => __( 'Bottom', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'input_bordercolor',
			[
				'label' => __( 'Input Border color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'inputicons',
			[
				'label' => __( 'Input icons', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => __( 'Default', 'imaginem-blocks-ii' ),
					'none' => __( 'None', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'inputicons_color',
			[
				'label' => __( 'Input icons color ', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .wpcf7-form .wpcf7-submit' => 'border-color: {{VALUE}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'button_textcolor',
			[
				'label' => __( 'Button Text Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'button_hovercolor',
			[
				'label' => __( 'Button Hover Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'.entry-content {{WRAPPER}} .wpcf7-form input[type="submit"]:hover' => 'background: {{VALUE}};',
					'{{WRAPPER}} .wpcf7-form input[type="submit"]:hover' => 'background: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Hover Text', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '.entry-content {{WRAPPER}} .wpcf7-form .wpcf7-submit,{{WRAPPER}} .wpcf7-form .wpcf7-submit',
			]
		);
