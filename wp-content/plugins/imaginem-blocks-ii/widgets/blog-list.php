...
class Blog_List extends Widget_Base {
	...
	public function get_title() {
		return __( 'Blog List', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Blog List', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'small' => __( 'Small', 'imaginem-blocks-ii' ),
				],
				'default' => 'default',
	...
	protected function render() {
		...
		$shortcode = '[bloglist cat_slugs="'.$cat_slugs.'" limit="'.$settings['limit'].'" pagination="'.$settings['pagination'].'"]';
