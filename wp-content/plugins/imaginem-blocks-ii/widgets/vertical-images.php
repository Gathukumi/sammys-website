...
class Em_Vertical_Images extends Widget_Base {
	...
	public function get_title() {
		return __( 'Vertical Images', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => __('Image title', 'imaginem-blocks-ii'),
				'desc' => __('Image title', 'imaginem-blocks-ii'),
				'options' => [
		...
		$this->add_control(
			...
			[
				'type' => \Elementor\Controls_Manager::SELECT,
				'label' => __('Image description', 'imaginem-blocks-ii'),
				'desc' => __('Image description', 'imaginem-blocks-ii'),
				'options' => [
					'true' => __('Yes','imaginem-blocks-ii'),
					'false' => __('No','imaginem-blocks-ii')
				],
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => __( 'Space between', 'imaginem-blocks-ii' ),
