...
class Pricing_Table extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing Table', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Pricing Table', 'imaginem-blocks-ii' ),
			]
		);
		...
		$repeater->add_control(
			'available', [
				'label' => __( 'Available', 'imaginem-blocks-ii' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
		...
		$repeater->add_control(
			'rowtext', [
				'type' => \Elementor\Controls_Manager::TEXT,
				'label' => __('Row Text', 'imaginem-blocks-ii'),
				'default' => __( 'Row Text', 'imaginem-blocks-ii' ),
				'placeholder' => __( 'Row Text', 'imaginem-blocks-ii' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'row',
			[
				'label' => __( 'Row', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'sep_color',
			[
				'label' => __( 'Seperator Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'separator' => 'before',
				'selectors' => [
					// Stronger selector to avoid section style from overwriting
		...
		$this->add_control(
			'Symbol_color',
			[
				'label' => __( 'Symbol Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'separator' => 'before',
				'selectors' => [
					// Stronger selector to avoid section style from overwriting
