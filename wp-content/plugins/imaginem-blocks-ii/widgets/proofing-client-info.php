...
class Proofing_Client_Info extends Widget_Base {
	...
	public function get_title() {
		return __( 'Proofing Info', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Proofing Info', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'centered' => __( 'Centered', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'curved' => __( 'Curved', 'imaginem-blocks-ii' ),
		...
		$this->add_responsive_control(
			'image_size',
			[
				'label' => __( 'Client Image Size', 'imaginem-blocks-ii' ),
		...
		[
		    'type' => \Elementor\Controls_Manager::SELECT,
		    'label' => __('Page Title', 'imaginem-blocks-ii'),
		    'options' => [
		...
		[
		    'type' => \Elementor\Controls_Manager::SELECT,
		    'label' => __('Client Name', 'imaginem-blocks-ii'),
		    'options' => [
		        'true' => __('Yes','imaginem-blocks-ii'),
		        'false' => __('No','imaginem-blocks-ii')
		    ],
		...
		[
		    'type' => \Elementor\Controls_Manager::SELECT,
		    'label' => __('Client Description', 'imaginem-blocks-ii'),
		    'options' => [
		        'true' => __('Yes','imaginem-blocks-ii'),
		        'false' => __('No','imaginem-blocks-ii')
		    ],
		...
		[
		    'type' => \Elementor\Controls_Manager::SELECT,
		    'label' => __('Time', 'imaginem-blocks-ii'),
		    'options' => [
		        'true' => __('Yes','imaginem-blocks-ii'),
		        'false' => __('No','imaginem-blocks-ii')
		    ],
		...
		[
		    'type' => \Elementor\Controls_Manager::SELECT,
		    'label' => __('Location', 'imaginem-blocks-ii'),
		    'options' => [
		        'true' => __('Yes','imaginem-blocks-ii'),
		        'false' => __('No','imaginem-blocks-ii')
		    ],
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'label' => __( 'Client Name Typography', 'imaginem-blocks-ii' ),
				'name' => 'clientnametype',
		...
		$this->add_control(
			...
			[
				'label' => __('Client Description Color', 'imaginem-blocks-ii'),
		        'std' => '',
		        'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'label' => __( 'Client Description Typography', 'imaginem-blocks-ii' ),
				'name' => 'clientdesctype',
		...
		$this->add_control(
		    'clientdetailscolor',
			[
				'label' => __('Client Details Color', 'imaginem-blocks-ii'),
		        'std' => '',
		        'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'label' => __( 'Client Details Typography', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			...
			[
				'label' => __('Client icon Color', 'imaginem-blocks-ii'),
		        'std' => '',
		        'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'label' => __( 'Client icon Typography', 'imaginem-blocks-ii' ),
		...
		$this->add_responsive_control(
			'infobordersize',
			[
				'label' => __( 'Info Border Size', 'imaginem-blocks-ii' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
		    'infobordersizecolor',
			[
				'label' => __('Info Border Color', 'imaginem-blocks-ii'),
		        'std' => '',
		        'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
