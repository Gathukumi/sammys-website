...
class Service_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'Service Box', 'imaginem-blocks-ii' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Service Box', 'imaginem-blocks-ii' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'stacked' => __( 'Stacked', 'imaginem-blocks-ii' ),
					'framed' => __( 'Framed', 'imaginem-blocks-ii' ),
				],
				'default' => 'default',
		...
		$this->add_responsive_control(
			'icon_space',
			[
				'label' => __( 'Space', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 6,
		...
		$this->add_control(
			'iconplace',
			[
				'label' => __( 'Icon Position', 'imaginem-blocks-ii' ),
				...
				'options' => [
					...
					'top' => [
						'title' => __( 'Top', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			...
			[
		        ...
		        'label' => __('Service Title', 'imaginem-blocks-ii'),
				'default' => __( 'This is the heading', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
		    'counto',
			[
				'label' => __( 'Count to Number', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			...
			[
		        ...
		        'label' => __('Service Content', 'imaginem-blocks-ii'),
				'default' => __( 'Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras mattis consectetur purus sit amet fermentum.', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			...
			[
		        'type' => Controls_Manager::TEXT,
		        'label' => __('Link Text', 'imaginem-blocks-ii'),
				'default' => __( 'Link Text', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'rotate',
			[
				'label' => __( 'Rotate', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
		...
		$this->add_control(
			'iconpadding',
			[
				'label' => __( 'Icon Padding', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'count_color',
			[
				'label' => __( 'Count Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'label' => __( 'Count Typography', 'imaginem-blocks-ii' ),
		...
		$this->add_control(
			'readmore_color',
			[
				'label' => __( 'Read More Color', 'imaginem-blocks-ii' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
	...
	public function wpml_widgets_to_translate_filter( $widgets ) {
		$widgets[ $this->get_name() ] = [
			...
			'fields'     => [
				[
					'field'       => 'title',
					'type'        => __( 'Service Title', 'imaginem-blocks-ii' ),
					'editor_type' => 'LINE'
				],
				[
					'field'       => 'content',
					'type'        => __( 'Service Content', 'imaginem-blocks-ii' ),
					'editor_type' => 'AREA'
				],
				[
					'field'       => 'linktext',
					'type'        => __( 'Link Text', 'imaginem-blocks-ii' ),
					'editor_type' => 'LINE'
				],
			],
		];
