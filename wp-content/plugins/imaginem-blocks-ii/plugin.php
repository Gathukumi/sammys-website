...
use ImaginemBlocks\Widgets\Em_FlipBox;
...
use ImaginemBlocks\Widgets\Em_Image_Reel;
use ImaginemBlocks\Widgets\Em_Clients_Grid;
...
class Plugin {
	...
	private function includes() {
		...
		require_once __DIR__ . '/widgets/flip-box-ii.php';
		...
		require_once __DIR__ . '/widgets/image-reel.php';
	...
	private function register_widget() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Em_FlipBox() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Em_Image_Reel() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Em_Clients_Grid() );
	...
	public function add_elementor_editor_scripts() {
		...
		wp_enqueue_script( 'googlemap', plugins_url( '/assets/js/googlemap.js', Imaginem_Blocks__FILE__ ),[],'1.8.9');
	...
	public function widget_scripts() {
		...
		wp_enqueue_script( 'imaginem-blocks', plugins_url( '/assets/js/common-elementor.js', Imaginem_Blocks__FILE__ ), [ 'jquery' ], '1.8.0', true );
		...
		// Before After
		wp_register_script( 'eventmove', plugins_url( '/assets/js/beforeafter/jquery.event.move.js', Imaginem_Blocks__FILE__ ), [ 'jquery' ], '1.8.9', true );
		wp_register_script( 'twentytwenty', plugins_url( '/assets/js/beforeafter/jquery.twentytwenty.js', Imaginem_Blocks__FILE__ ), [ 'jquery' ], '1.8.9', true );
