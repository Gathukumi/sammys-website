...
class Imaginem_Proofing_Posts {
	...
	*************************************** */
	...
	function proofing_edit_columns($columns){
	    $new_columns = array(
	        "mproofing_section" => __('Proofing Category','imaginem-blocks-ii'),
	        "proofing_image" => __('Image','imaginem-blocks-ii'),
	        "proofing_client" => __('Client','imaginem-blocks-ii')
	    );
	...
	*/
	...
	function init()
	{
	    ...
	    $mtheme_proofing_slug="proofing";
	    if (function_exists('blacksilver_get_option_data')) {
	    	$mtheme_proofing_slug = blacksilver_get_option_data('proofing_permalink_slug');
		}
	    if ( $mtheme_proofing_slug=="" || !isSet($mtheme_proofing_slug) ) {
	        $mtheme_proofing_slug="proofing";
	    }
	    $args = array(
            'labels' => array(
                'name' => __('Photo Proofing','imaginem-blocks-ii'),
                'menu_name' => __('Photo Proofing','imaginem-blocks-ii'),
                'singular_name' => __('Photo Proofing','imaginem-blocks-ii'),
                'all_items' => __('All Proofings','imaginem-blocks-ii'),
                'add_new' => __('Add New Proofing','imaginem-blocks-ii')
            ),
	        'singular_label' => 'mproofing',
	        'public' => true,
	        ...
	        'rewrite' => array('slug' => $mtheme_proofing_slug),//Use a slug like "work" or "project" that shouldnt be same with your page name
		...
		*/
	    register_taxonomy( 'proofingsection', array( 'proofing' ),
	        array(
	            'labels' => array(
	                'name' => __('Proofing Categories','imaginem-blocks-ii'),
	                'menu_name' => __('Proofing Categories','imaginem-blocks-ii'),
	                'singular_name' => __('Proofing Category','imaginem-blocks-ii'),
	                'all_items' => __('Proofing Categories','imaginem-blocks-ii')
	            ),
	            'public' => true,
	            'hierarchical' => true,
	            'show_ui' => true,
	...
	*/
	...
	function clients_edit_columns($columns){
	    ...
	    $columns = array(
	        ...
	        "title" => __('Client Title','imaginem-blocks-ii'),
			"clients_image" => __('Image','imaginem-blocks-ii')
	    );
	...
	function init()
	{
		...
		*/
	    ...
	    if (function_exists('blacksilver_get_option_data')) {
	    	$mtheme_clients_slug = blacksilver_get_option_data('client_permalink_slug');
		}
	    ...
	    $args = array(
            'labels' => array(
                'name' => __('Clients','imaginem-blocks-ii'),
                'menu_name' => __('Clients','imaginem-blocks-ii'),
                'singular_name' => __('Clients','imaginem-blocks-ii'),
                'all_items' => __('All Clients','imaginem-blocks-ii'),
                'add_new' => __('Add New Client','imaginem-blocks-ii')
            ),
	        'singular_label' => __('Client','imaginem-blocks-ii'),
	        'public' => true,
	        'show_ui' => true,
	        'capability_type' => 'post',
	        'hierarchical' => true,
