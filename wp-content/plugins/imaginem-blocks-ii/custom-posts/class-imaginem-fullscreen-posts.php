...
class Imaginem_Fullscreen_Posts {
	...
	?>
		<div class="wrap">
		<h2><?php _e('Sort Fullscreen','imaginem-blocks-ii'); ?><img src="<?php echo home_url(); ?>/wp-admin/images/loading.gif" id="loading-animation" /></h2>
	...
	*/
	...
	function mtheme_fullscreen_edit_columns($columns){
	    $columns = array(
	        ...
	        "title" => __('Featured Title','imaginem-blocks-ii'),
	        "fullscreengallery" => __('Categories','imaginem-blocks-ii'),
	        "fullscreen_type" => __('Fullscreen Type','imaginem-blocks-ii'),
	        "featured_image" => __('Image','imaginem-blocks-ii')
	    );
	...
	function init()
	{
	    ...
	    $args = array(
	        'label' => __('Fullscreen Pages','imaginem-blocks-ii'),
	        'description' => __('Manage your Fullscreen posts','imaginem-blocks-ii'),
	        'singular_label' => __('Fullscreen','imaginem-blocks-ii'),
	        'public' => true,
	        'show_ui' => true,
