...
class Imaginem_Event_Posts {
	...
	*************************************** */
	...
	?>
		<div class="wrap">
		<h2><?php _e('Sort Events','imaginem-blocks-ii'); ?><img src="<?php echo home_url(); ?>/wp-admin/images/loading.gif" id="loading-animation" /></h2>
	...
	function events_edit_columns($columns){
	    $new_columns = array(
	        "mevent_section" => __('Section','imaginem-blocks-ii'),
	        "event_image" => __('Image','imaginem-blocks-ii')
	    );
	...
	*/
	...
	function init()
	{
		...
		*/
	    ...
	    $args = array(
            'labels' => array(
                'name' => __('Event','imaginem-blocks-ii'),
                'menu_name' => __('Events','imaginem-blocks-ii'),
                'singular_name' => __('Event','imaginem-blocks-ii'),
                'all_items' => __('All Events','imaginem-blocks-ii')
            ),
	        'singular_label' => __('Event','imaginem-blocks-ii'),
	        'public' => true,
		...
		*/
	    register_taxonomy( 'eventsection', array( 'events' ),
	        array(
	            'labels' => array(
	                'name' => __('Sections','imaginem-blocks-ii'),
	                'menu_name' => __('Sections','imaginem-blocks-ii'),
	                'singular_name' => __('Section','imaginem-blocks-ii'),
	                'all_items' => __('All Sections','imaginem-blocks-ii')
	            ),
	            'public' => true,
	            'hierarchical' => true,
	            'show_ui' => true,
