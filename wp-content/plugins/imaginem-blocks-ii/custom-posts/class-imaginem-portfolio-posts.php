...
class Imaginem_Portfolio_Posts {
	...
	?>
		<div class="wrap">
		<h2><?php _e('Sort Portfolio','imaginem-blocks-ii'); ?><img src="<?php echo home_url(); ?>/wp-admin/images/loading.gif" id="loading-animation" /></h2>
		<div class="description">
		<?php _e('Drag and Drop the slides to order them','imaginem-blocks-ii'); ?>
		</div>
	...
	*/
	...
	function portfolio_edit_columns($columns){
	    $columns = array(
	        ...
	        "title" => __('Portfolio Title','imaginem-blocks-ii'),
	        "theme_description" => __('Description','imaginem-blocks-ii'),
			"video" => __('Video','imaginem-blocks-ii'),
	        "types" => __('Types','imaginem-blocks-ii'),
			"portfolio_image" => __('Image','imaginem-blocks-ii')
	    );
	...
	function init()
	{
		...
		*/
	    ...
	    $args = array(
	        ...
	        'singular_label' => __('Portfolio','imaginem-blocks-ii'),
	        'public' => true,
	        'show_ui' => true,
		...
		*/
		register_taxonomy("types", array("portfolio"), array("hierarchical" => true, "label" => __("Work Type","imaginem-blocks-ii"), "singular_label" => __("Types","imaginem-blocks-ii"), "rewrite" => true));

		$filtertag_labels = array(
			'name'              => _x( 'Filter Tag', 'imaginem-blocks-ii' ),
			'singular_name'     => _x( 'Filter Tag', 'imaginem-blocks-ii' ),
			'search_items'      => __( 'Search Filter Tags', 'imaginem-blocks-ii' ),
			'all_items'         => __( 'All Filter Tags', 'imaginem-blocks-ii' ),
			'parent_item'       => __( 'Parent Filter Tags', 'imaginem-blocks-ii' ),
			'parent_item_colon' => __( 'Parent Filter Tags:', 'imaginem-blocks-ii' ),
			'edit_item'         => __( 'Edit Filter Tags', 'imaginem-blocks-ii' ),
			'update_item'       => __( 'Update Filter Tags', 'imaginem-blocks-ii' ),
			'add_new_item'      => __( 'Add New Filter Tags', 'imaginem-blocks-ii' ),
			'new_item_name'     => __( 'New Filter Tag', 'imaginem-blocks-ii' ),
			'menu_name'         => __( 'Filter Tags', 'imaginem-blocks-ii' ),
		);
...
class mtheme_Worktype_add_image {
	...
	function mtheme_worktype_columns($columns) {
	    $columns['worktype_image'] = __('Image','imaginem-blocks-ii');
	    return $columns;
	}
