...
if ( !function_exists( 'proofing' ) ) {
	...
	$preload_tag = '<div class="preloading-placeholder"><span class="preload-image-animation"></span><img src="'.get_template_directory_uri().$protected_placeholder.'" alt="preloading" /></div>';
		...
		if ( $filter_image_ids ) {
			...
			// Filterables
		$thumbnails .= '<div class="gridblock-header-wrap gridblock-filter-type-'. esc_attr( $type ) .'  fullpage-item">';
		...
		if ( $type == "filter" ) {
			...
			if ( 'false' !== $title && $style !== 'classic' ) {
				$portfoliogrid ='<div class="work-details work-details-boxed">';
						$portfoliogrid .= '<h4>';
						switch ($title) {
							case 'imageid':
			...
			$thumbnails .=  '</div>';
			if ( 'false' !== $title && $style == 'classic' ) {
				$portfoliogrid ='<div class="work-details work-details-classic">';
						$portfoliogrid .= '<h4>';
						switch ($title) {
							case 'imageid':
								$portfoliogrid .= '#'. $attachment_id;
