...
public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Theme widget to upload image', 'imaginem-blocks-ii' ), ) // Args
		);
	}
...
function mtheme_image_script(){
	...
	wp_enqueue_media();
	wp_enqueue_script('adsScript', plugins_url( '/js/image-upload-widget.js' , __FILE__ ), array(), '1.7.6', true );
}
