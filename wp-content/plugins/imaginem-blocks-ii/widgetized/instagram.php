...
class mTheme_Instagram_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'mtheme_instagram_widget', 'description' => __( 'Instagram Embed Widget', 'imaginem-blocks-ii') );
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('instagram_details',__('Blacksilver Instagram', 'imaginem-blocks-ii'), $widget_ops,$control_ops);
		
	}
	
	public function widget( $args, $instance ) {
		extract( $args );
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Instagram', 'imaginem-blocks-ii') : $instance['title'], $instance, $this->id_base);
