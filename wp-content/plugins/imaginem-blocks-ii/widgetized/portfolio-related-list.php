...
class mTheme_Portfolio_Related_List_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'mtheme_portfolio_related_widget', 'description' => __( 'Displays list of related portfolio projects', 'imaginem-blocks-ii') );
		parent::__construct('portfolio_related_list',__('Blacksilver Portfolio Related List', 'imaginem-blocks-ii'), $widget_ops);
		
	}
	
	public function widget( $args, $instance ) {
		extract( $args );
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Related Projects', 'imaginem-blocks-ii') : $instance['title'], $instance, $this->id_base);
		$text = $instance['text'];
