...
class mTheme_Address_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'mtheme_contact_widget', 'description' => __( 'Display your contact details', 'imaginem-blocks-ii') );
		parent::__construct('contact_details',__('Blacksilver Address', 'imaginem-blocks-ii'), $widget_ops);
		
	}
	
	public function widget( $args, $instance ) {
		extract( $args );
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Address', 'imaginem-blocks-ii') : $instance['title'], $instance, $this->id_base);
		$text = $instance['text'];
	...
	?>
		...
		<textarea class="widefat" id="<?php echo $this->get_field_id('text'); ?>" name="<?php echo $this->get_field_name('text'); ?>"><?php echo esc_textarea($text); ?></textarea></p>
		
		<p><label for="<?php echo $this->get_field_id('name'); ?>"><?php _e('Company:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('city'); ?>"><?php _e('City:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('state'); ?>"><?php _e('State:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('zip'); ?>"><?php _e('Zip:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('phone'); ?>"><?php _e('Phone:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('phone_link'); ?>"><?php _e('Phone Link:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('cellphone'); ?>"><?php _e('Cell phone:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('cellphone_link'); ?>"><?php _e('Cell phone link:', 'imaginem-blocks-ii'); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('e-mail:', 'imaginem-blocks-ii'); ?></label>
