...
class mtheme_Recent_Posts extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_recent_posts', 'description' => __( "Displays the recent posts", 'imaginem-blocks-ii') );
		parent::__construct('recent_posts', __('Blacksilver Recent Posts', 'imaginem-blocks-ii'), $widget_ops);
	...
	public function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts', 'imaginem-blocks-ii') : $instance['title'], $instance, $this->id_base);
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('desc_length'); ?>"><?php _e('Description Lenght:', 'imaginem-blocks-ii'); ?></label>
