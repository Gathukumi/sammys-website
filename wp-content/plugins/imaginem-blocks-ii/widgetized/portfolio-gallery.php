...
class mtheme_PortfolioGallery_Widget extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'widget_mtheme_portfolio_gallery', 'description' => __('Generates an image gallery.','imaginem-blocks-ii') );
		parent::__construct('mtheme_portfolio_gallery', __('Blacksilver Portfolio Gallery Widget','imaginem-blocks-ii'), $widget_ops);
	}
