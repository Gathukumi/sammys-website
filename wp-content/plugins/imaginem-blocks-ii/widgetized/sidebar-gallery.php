...
class mtheme_SidebarGallery_Widget extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'widget_mtheme_sidebar_gallery', 'description' => __('Generates an image gallery.','imaginem-blocks-ii') );
		parent::__construct('mtheme_sidebar_gallery', __('Blacksilver Gallery Widget','imaginem-blocks-ii'), $widget_ops);
	}
	...
	<?php // Title Field ?>	
	<p>
	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:','imaginem-blocks-ii'); ?></label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('listchoice'); ?>">
			<?php _e('List Choice:','imaginem-blocks-ii'); ?>
		</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('thepage'); ?>">
			<?php _e('Select Page <br/><small><strong>If List-Choice is Page</strong></small> :','imaginem-blocks-ii'); ?>
		</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('thecategory'); ?>">
			<?php _e('Select Category <br/><small><strong>If List-Choice is Category</strong></small> :','imaginem-blocks-ii'); ?>
		</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('theportfolio'); ?>">
			<?php _e('Select Portfolio <br/><small><strong>If List-Choice is Portfolio</strong></small> :','imaginem-blocks-ii'); ?>
		</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('clickaction'); ?>">
			<?php _e('Click Action:','imaginem-blocks-ii'); ?>
		</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('galleryorder'); ?>">
			<?php _e('Image Order:','imaginem-blocks-ii'); ?>
		</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('thelimit'); ?>">
			<?php _e('Limit Portfolio:','imaginem-blocks-ii'); ?>
		</label>
