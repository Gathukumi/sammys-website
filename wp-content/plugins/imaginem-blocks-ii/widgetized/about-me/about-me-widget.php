...
public function __construct() {
		parent::__construct(
			...
			__('Blacksilver About me Widget','imaginem-blocks-ii'), // Name
			array( 'description' => __( 'Theme widget for About me information', 'imaginem-blocks-ii' ), ) // Args
		);
	}
    ...
    <div class="mtheme-image-uploader-widget">
        ...
        <input type="button" value="<?php _e( 'Upload Image', 'imaginem-blocks-ii' ); ?>" class="button aboutme_media_upload custom_media_upload" id="custom_image_uploader"/>
        </p>
    	
    	<p><label for="<?php echo $this->get_field_id('name'); ?>"><?php _e('Name', 'imaginem-blocks-ii'); ?><br /></label>
    	...
    	<p><label for="<?php echo $this->get_field_id('desc'); ?>"><?php _e('Description', 'imaginem-blocks-ii'); ?><br /></label>
      	<textarea class="widefat" id="<?php echo $this->get_field_id('desc'); ?>" name="<?php echo $this->get_field_name('desc'); ?>"><?php echo $desc; ?></textarea>
        </p>
    	<p><label for="<?php echo $this->get_field_id('button_text'); ?>"><?php _e('Button Text', 'imaginem-blocks-ii'); ?><br /></label>
    	...
    	<p><label for="<?php echo $this->get_field_id('button_url'); ?>"><?php _e('Button URL', 'imaginem-blocks-ii'); ?><br /></label>
...
function mtheme_aboutme_script(){
	...
	wp_enqueue_media();
	wp_enqueue_script('about-me-widget', plugins_url( '/js/about-me-widget.js' , __FILE__ ), array(), '1.7.6', true );
}
